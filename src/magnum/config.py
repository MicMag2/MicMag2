...
from optparse import OptionParser, OptionValueError, OptionGroup, BadOptionError,AmbiguousOptionError
...
class MagnumConfig(object):
    ...
    def parseCommandLine(self, argv):
        ...
        ctrl_group.add_option("--multi_py",
          action  = "store_true",
          help    = "switches on python thread distribution (multithreading). simulations start in seperate subdirectories.",
          dest    = "toggle_multi_thread_py",
          default = False,
        )
        ctrl_group.add_option("--multi_py_no_sort",
          action  = "store_true",
          help    = "switches on python thread distribution (multithreading). simulations start in same directory as host script.",
          dest    = "toggle_multi_thread_py_1F",
          default = False,
        )
